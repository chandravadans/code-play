package com.cv.codepad.concurrency.cyclicbarrier;
...
public class CyclicBarrierDemo {
    ...
    public void runSimulation(int numWorkers, int numberOfPartialResults) {
        ...
        cyclicBarrier = new CyclicBarrier(NUM_WORKERS, new FinalAggregator());
    ...
    class FinalAggregator implements Runnable {
